...
export const CARDS: Record<string, UnitStats> = {
  pikachu: {
    ...
    rarity: 'rare', trait: 'Fast bolts — zaps air & ground',
  ...
  charizard: {
    ...
    rarity: 'legendary', trait: 'Flying fireballs — splash damage',
  ...
  squirtle: {
    ...
    rarity: 'common', trait: 'Cheap water plinker — hits air',
  ...
  bulbasaur: {
    ...
    rarity: 'common', trait: 'Sturdy seed shooter — ground only',
  ...
  machamp: {
    ...
    rarity: 'epic', trait: 'Four-armed wall — heavy punches', meleeStyle: 'punch',
  },
  golem: {
    ...
    rarity: 'legendary', trait: 'Tower-smashing tank — slow slams', meleeStyle: 'slam',
  },
  gengar: {
    ...
    rarity: 'epic', trait: 'Fast assassin — shadow slashes', meleeStyle: 'slash',
  },
  eevee: {
    ...
    rarity: 'common', trait: 'Swarm of three — surrounds & bites', meleeStyle: 'bite',
  },
  thunder: {
    ...
    rarity: 'epic', trait: 'Spell — nukes a tight cluster',
  ...
  machoke: {
    ...
    rarity: 'rare', trait: 'Glass-cannon brawler — fast punches', meleeStyle: 'punch',
  },
  snorlax: {
    ...
    rarity: 'epic', trait: 'Lane-blocking wall — taunts tanks', meleeStyle: 'slam',
  },
  dragonite: {
    ...
    rarity: 'legendary', trait: 'Aerial tower buster — heavy slams', meleeStyle: 'slam',
  },
  zubat: {
    ...
    rarity: 'common', trait: 'Flying swarm — premium anti-air', meleeStyle: 'bite',
  },
  fireblast: {
    ...
    speed: 0, flying: false, targetsAir: true,
    radius: 0, height: 0, aggro: 0,
    rarity: 'rare', trait: 'Spell — splash damage + knockback',
  ...
  icebeam: {
    ...
    speed: 0, flying: false, targetsAir: true,
    radius: 0, height: 0, aggro: 0,
    rarity: 'rare', trait: 'Spell — freezes a push for 4s',
