...
export const CARDS: Record<string, UnitStats> = {
  pikachu: {
    ...
    type: 'electric', rarity: 'rare', trait: 'Fast bolts — zaps air & ground',
    projectile: { speed: 20, arc: 0.25, color: 0xffe94d, size: 0.12, style: 'bolt' },
  },
  charizard: {
    ...
    type: 'fire', rarity: 'legendary', trait: 'Flying fireballs — splash damage',
    projectile: { speed: 12, arc: 0.5, color: 0xff7a2d, size: 0.18, splash: 1.5, style: 'fireball' },
  },
  squirtle: {
    ...
    type: 'water', rarity: 'common', trait: 'Cheap water plinker — hits air',
    projectile: { speed: 15, arc: 0.45, color: 0x5db9ff, size: 0.13, style: 'bubble' },
  },
  bulbasaur: {
    ...
    type: 'grass', rarity: 'common', trait: 'Sturdy seed shooter — ground only',
    projectile: { speed: 14, arc: 0.4, color: 0x7ed957, size: 0.13, style: 'leaf' },
  },
  machamp: {
    ...
    type: 'fighting', rarity: 'epic', trait: 'Four-armed wall — heavy punches', meleeStyle: 'punch',
  },
  golem: {
    ...
    type: 'rock', rarity: 'legendary', trait: 'Tower-smashing tank — slow slams', meleeStyle: 'slam',
  },
  gengar: {
    ...
    type: 'ghost', rarity: 'epic', trait: 'Fast assassin — shadow slashes', meleeStyle: 'slash',
  },
  eevee: {
    ...
    type: 'normal', rarity: 'common', trait: 'Swarm of three — surrounds & bites', meleeStyle: 'bite',
  },
  thunder: {
    ...
    type: 'electric', rarity: 'epic', trait: 'Spell — nukes a tight cluster',
  ...
  machoke: {
    ...
    type: 'fighting', rarity: 'rare', trait: 'Glass-cannon brawler — fast punches', meleeStyle: 'punch',
  },
  snorlax: {
    ...
    type: 'normal', rarity: 'epic', trait: 'Lane-blocking wall — taunts tanks', meleeStyle: 'slam',
  },
  dragonite: {
    ...
    type: 'dragon', rarity: 'legendary', trait: 'Aerial tower buster — heavy slams', meleeStyle: 'slam',
  },
  zubat: {
    ...
    type: 'poison', rarity: 'common', trait: 'Flying swarm — premium anti-air', meleeStyle: 'bite',
  },
  fireblast: {
    ...
    speed: 0, flying: false, targetsAir: true,
    radius: 0, height: 0, aggro: 0,
    type: 'fire', rarity: 'rare', trait: 'Spell — splash damage + knockback',
  ...
  icebeam: {
    ...
    speed: 0, flying: false, targetsAir: true,
    radius: 0, height: 0, aggro: 0,
    type: 'ice', rarity: 'rare', trait: 'Spell — freezes a push for 4s',
